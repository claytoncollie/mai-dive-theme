...
function maidive_load_scripts() {
	...
	wp_enqueue_script( 'maidive-responsive-menu', get_bloginfo( 'stylesheet_directory' ) . '/js/responsive-menu.js', array( 'jquery' ), '1.0.0' );
...
genesis_register_sidebar( array(
	'id'          => 'home-bottom',
	'name'        => __( 'Home Bottom', 'maidive' ),
	'description' => __( 'This is the bottom section of the homepage.', 'maidive' ),
) );
